...
class RobustLocationScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RobustLocationScreen> createState() => _RobustLocationScreenState();
}
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ref.read(robustLocationTrackingProvider.notifier).clearError();
                          ref.read(robustLocationTrackingProvider.notifier).initialize();
                        },
                              ...
                              ElevatedButton.icon(
                                onPressed: () async {
                                  try {
                                    ...
                                    print('🧪 Manual location test: ${position.latitude}, ${position.longitude}');
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const RobustFeatureItem(
                                ...
                                description: 'Continues tracking even when app is closed',
                                color: Colors.green,
                              ),
                              const RobustFeatureItem(
                                icon: Icons.lock,
                                title: 'Works when phone is locked',
                                description: 'Background service runs with screen off',
                                color: Colors.green,
                              ),
                              const RobustFeatureItem(
                                icon: Icons.power_settings_new,
                                title: 'Works until phone is switched off',
                                description: 'Persistent tracking with auto-restart',
                                color: Colors.green,
                              ),
                              const RobustFeatureItem(
                                icon: Icons.timer,
                                title: '2-minute updates',
                                description: 'Frequent location updates for accuracy',
                                color: Colors.blue,
                              ),
                              const RobustFeatureItem(
                                icon: Icons.cloud_upload,
                                title: 'Multiple sync methods',
                                description: 'Background service + Background fetch + Firebase',
                                color: Colors.blue,
                              ),
                              const RobustFeatureItem(
                                icon: Icons.notifications_active,
                                title: 'Idle detection',
                                description: 'Alerts when employee is idle for 15+ minutes',
                                color: Colors.orange,
                              ),
                            ],
                          ),
                                  ...
                                  if (snapshot.hasData) {
                                    ...
                                    return Column(
                                      children: [
                                        ...
                                        PermissionItem(
                                          title: 'System Alert',
                                          granted: permissions['systemAlert'] ?? false,
                                        ),
                                      ],
                                    );
                                  }
